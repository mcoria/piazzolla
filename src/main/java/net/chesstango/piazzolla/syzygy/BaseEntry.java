...
import static net.chesstango.piazzolla.syzygy.TableBase.TableType.*;
...
abstract class BaseEntry {
    ...
    int probe_wdl(SyzygyPosition syzygyPosition, long key, int score) {
        return wdl.probe_table(syzygyPosition, key, score);
    }
