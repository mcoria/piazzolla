...
import static net.chesstango.syzygy.Chess.*;
import static net.chesstango.syzygy.SyzygyConstants.Piece.*;
import static net.chesstango.syzygy.SyzygyConstants.*;
import static net.chesstango.syzygy.SyzygyConstants.PieceType.*;
import static net.chesstango.syzygy.TableBase.TableType.*;
